...
export default function Lucia() {
    useGSAP(() => {
        ...
        timeline.to(".second-vd", {opacity: 0, duration: 1, ease: "power1.inOut"});
            ...
            <div className="lg:w-1/2 lucia-life-content">
                <div className="max-w-xl lg:ps-32 ps-10">
                    ...
                    <p>
                        ...
                        Leonida Penitentiary. Sheer luck got her out. Lucia’s learned her lesson — only smart moves from
                        here.
                    </p>
                </div>
                ...
                <p className="max-w-xl lg:ps-32 ps-10">
                    More than anything, Lucia wants the good life her mom has dreamed of since their days in Liberty
                    City — but instead of half-baked fantasies, Lucia is prepared to take matters into her own hands.
                </p>
            </div>
        </section>
    );
